#!/usr/bin/env sage
"""
ECFFT Precomputation Script for Helioselene

Generates static precomputed data (.inl files) for Elliptic Curve Fast Fourier
Transform (ECFFT) polynomial evaluation and interpolation over the Helios/Selene
...
References:
  ...
  [FCMP]    FCMP++ specification — Helios/Selene curve cycle.
...
def generate_fq(known_a=None, known_b=None, known_order=None, seed_value=None):
    ...
    # q = 2^255 - gamma, where gamma is the Helios group order / Selene base field
